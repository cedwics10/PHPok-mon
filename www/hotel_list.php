...
<th>hot_nom</th>
<th>hot_adresse</th>
<th>hot_departement</th>
<th>hot_description</th>
<th>hot_longitude</th>
<th>hot_latitude</th>
<th>hot_hocategorie</th>
...
<td><?=$hot_nom?></td>
<td><?=$hot_adresse?></td>
<td><?=$hot_departement?></td>
<td><?=$hot_description?></td>
<td><?=$hot_longitude?></td>
<td><?=$hot_latitude?></td>
<td><?=$hot_hocategorie?></td>

                <td><a href='hotel_edit.php?id=<?=$id?>'>modifier</a></td>
                <td><a href='hotel_delete.php?id=<?=$id?>'>supprimer</a></td>
                </tr>
            <?php } //fin foreach ?>
        </table>
    </main>
