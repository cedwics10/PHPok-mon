...
if (isset($btsubmit)) {
    ...
    if ($per_id==0) 
        ...
        $sql="insert into personnel (per_id,per_nom,per_identifiant,per_mdp,per_email,per_role,per_hotel) values (null,'$per_nom','$per_identifiant','$per_mdp','$per_email','$per_role','$per_hotel')";
    else
