...
<body>
    ...
    <main id="main">
        <h2>hocategorie</h2>     
        <p><a href="hocategorie_edit.php?id=0">Créer un enregistrement</a></p> 
        <table>
            <thead>
                <tr>
                    <th>hoc_id</th>
...
<td><?=$hoc_categorie?></td>
                ...
                <td><a href='hocategorie_edit.php?id=<?=$id?>'>modifier</a></td>
                <td><a href='hocategorie_delete.php?id=<?=$id?>'>supprimer</a></td>
                </tr>
            <?php } //fin foreach ?>
        </table>
    </main>
