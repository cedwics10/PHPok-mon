...
<body>
    ...
    <main id="main">
        <h2>pokemons</h2>     
        <p><a href="pokemons_edit.php?id=0">Créer un enregistrement</a></p> 
        <table>
            <thead>
                <tr>
                    <th>pok_id</th>
...
<td><?=$pok_nom?></td>
                ...
                <td><a href='pokemons_edit.php?id=<?=$id?>'>modifier</a></td>
                <td><a href='pokemons_delete.php?id=<?=$id?>'>supprimer</a></td>
                </tr>
            <?php } //fin foreach ?>
        </table>
    </main>
