...
if (isset($btsubmit)) {
    ...
    if ($res_id==0) 
        ...
        $sql="insert into reservation (res_id,res_date_creation,res_date_debut,res_date_maj,res_date_fin,res_etat,res_client,res_hotel,res_chambre) values (null,'$res_date_creation','$res_date_debut','$res_date_maj','$res_date_fin','$res_etat','$res_client','$res_hotel','$res_chambre')";
    else
