...
<body>
    ...
    <main id="main">
        <h2>dresseurs</h2>     
        <p><a href="dresseurs_edit.php?id=0">Créer un enregistrement</a></p> 
        <table>
            <thead>
                <tr>
                    <th>dre_id</th>
...
<td><?=$dre_nom?></td>
                ...
                <td><a href='dresseurs_edit.php?id=<?=$id?>'>modifier</a></td>
                <td><a href='dresseurs_delete.php?id=<?=$id?>'>supprimer</a></td>
                </tr>
            <?php } //fin foreach ?>
        </table>
    </main>
