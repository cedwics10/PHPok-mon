...
<body>
    ...
    <main id="main">
        <h2>est_type</h2>     
        <p><a href="est_type_edit.php?id=0">Créer un enregistrement</a></p> 
        <table>
            <thead>
                <tr>
                    <th>est_id</th>
...
<td><?=$est_type_id?></td>
                ...
                <td><a href='est_type_edit.php?id=<?=$id?>'>modifier</a></td>
                <td><a href='est_type_delete.php?id=<?=$id?>'>supprimer</a></td>
                </tr>
            <?php } //fin foreach ?>
        </table>
    </main>
