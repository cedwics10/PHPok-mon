...
if (isset($btsubmit)) {
    ...
    if ($cha_id==0) 
        ...
        $sql="insert into chambre (cha_id,cha_numero,cha_statut,cha_surface,cha_typelit1,cha_typelit2,cha_description,cha_jacuzzi,cha_balcon,cha_wifi,cha_minibar,cha_coffre,cha_vue,cha_chcategorie) values (null,'$cha_numero','$cha_statut','$cha_surface','$cha_typelit1','$cha_typelit2','$cha_description','$cha_jacuzzi','$cha_balcon','$cha_wifi','$cha_minibar','$cha_coffre','$cha_vue','$cha_chcategorie')";
    else
