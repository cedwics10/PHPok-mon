...
if (isset($btsubmit)) {
    ...
    if ($hot_id==0) 
        ...
        $sql="insert into hotel (hot_id,hot_statut,hot_nom,hot_adresse,hot_departement,hot_description,hot_longitude,hot_latitude,hot_hocategorie) values (null,'$hot_statut','$hot_nom','$hot_adresse','$hot_departement','$hot_description','$hot_longitude','$hot_latitude','$hot_hocategorie')";
    else
